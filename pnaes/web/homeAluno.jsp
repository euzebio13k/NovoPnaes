            ...
            <div class="col-md-8 col-xl-10 ">
                <div class="element-box" >
                    <h1 class="form-header text-center" >
                        ...
                        <button  class="mr-2 mb-3 btn btn-primary btn-lg btn-block" type="button" onclick="continuarInscricao()">Fazer Pedido do (s) Auxílio (s) para o Edital Nº <%=edital.getNumeroEAno()%> - <i>Campus </i> </button>
                    </h1>
                </div>
            </div>
        </div>
