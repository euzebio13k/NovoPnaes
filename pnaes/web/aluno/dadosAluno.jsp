        ...
        <div id="accordion2">
            ...
            <div>
                <table class="table table-striped table-responsive-md">
                    ...
                    <tr>    
                        <th>Período:</th>
                        <td><%=aluno.getPeriodo()%>º <%=aluno.getCurso().getTipoPeriodo()%></td>
                    </tr>
                    <tr>    
                        ...
                        <tr class="DadosDespesaOutra">  
                            ...
                            <td class="edicaoDadosDespesa" style="display: none;">
                                      <textarea name="qualOutrasDespesas" rows="4" cols="50" placeholder="Especifique Quais são as Outras Despesas" id="qualOutrasDespesas"<%
                                                                       if (despesa.getOutrasDespesas() > 0) {
                                                                           out.print("required");
                                                                       }%>><%=despesa.getQualOutrasDespesas() != null || despesa.getQualOutrasDespesas().equals("") ? despesa.getQualOutrasDespesas() : ""%></textarea>
                            </td>
                        </tr>
                        <%if (request.getParameter("editar") != null) {%>
                        <tr>
