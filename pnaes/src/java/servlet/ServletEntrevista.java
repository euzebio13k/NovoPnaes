        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (opcao) {
                ...
                case "alterarEntrevista":
                    ...
                    daoFactory.getEntrevistaDao().inserirOuAlterar(entrevista);
                    response.sendRedirect("entrevista/listarEntrevistados.jsp");
                    break;    
                case "finalizar":
                    entrevista = (Entrevista) daoFactory.getEntrevistaDao().pesquisarPorId(Integer.parseInt(request.getParameter("e_id")));
                    ...
                    Bolsa rb1 = new Bolsa();
                    rb1.setId(Integer.parseInt(request.getParameter("resultadoBolsa1")));
                    entrevista.setResultadoBolsa1(rb1);
                    Bolsa rb2 = new Bolsa();
                    rb2.setId(Integer.parseInt(request.getParameter("resultadoBolsa2")));
                    entrevista.setResultadoBolsa2(rb2);
